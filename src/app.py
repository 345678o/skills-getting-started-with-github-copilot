...
activities = {
    ...
    "Gym Class": {
        ...
        "Soccer Team": {
        "description": "Practice team tactics and compete in friendly matches",
    ...
    "Drama Club": {
        "description": "Rehearse scenes and perform short plays for the school",
        "schedule": "Fridays, 3:30 PM - 5:00 PM",
        "max_participants": 20,
        "participants": []
    },
    ...
    "Science Debate": {
        "description": "Discuss scientific topics and sharpen argument skills",
